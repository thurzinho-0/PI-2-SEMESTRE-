...
<body>
    <form class="form" method="POST" action="processa_login.php">
        ...
        <div class="inputForm">
            ...
            <input type="email" class="input" placeholder="Digite seu e-mail" name="email" required />
        </div>
        ...
        <div class="inputForm">
            ...
            <input type="password" class="input" placeholder="Digite sua senha" name="senha" required />
        </div>
